...
You need to run this bot on your server and register it using id and password received from BotFather. If you would like my osted bot to do a service for you instead, feel free to contact me then.
